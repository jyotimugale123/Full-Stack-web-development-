...
const setWeatherDetails = (data) => {
    ...
    switch (data.weather[0].main) {
        case 'Clouds':
            weatherIcon.src = "https://cdn-icons-gif.flaticon.com/6455/6455053.gif";
            break;
        case 'Clear':
            weatherIcon.src = "https://cdn-icons-gif.flaticon.com/6455/6455053.gif";
            break;
        ...
        case 'Snow':
            ...
            break;
        case 'Haze':
            weatherIcon.src = "https://icon-library.com/images/weather-icon-gif/weather-icon-gif-21.jpg";
            break;
    }
}
